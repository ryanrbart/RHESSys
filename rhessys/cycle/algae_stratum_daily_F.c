...
double	compute_direct_radiative_fluxes(
    ...
    double scm_temp, scm_volume, scm_area, scm_photo_depth;
    double tmax,tmin;
    ...
    // ONLY RUN IF THERE IS A DETENTION STORE...
    ...
    scm_photo_depth = min(detention_store, scm_photo_depth);
    ...
    // ARE THERE OTHER (not algae) STRATUM VARIABLES THAT NEED TO BE UPDATED?
    ...
    /*--------------------------------------------------------------*/
     ...
     /// NOTE: FOR EACH OF THESE PRINT COMMANDS, I GET A WARNING SAYING IT EXPETS an 'int' but is getting a 'longint' - cdb 05/14/2014
